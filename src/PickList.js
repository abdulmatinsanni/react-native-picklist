...
import HeaderBackButton from "react-navigation-stack/src/views/Header/HeaderBackButton";
...
export default class extends React.PureComponent {
  ...
  static defaultProps = {
    ...
    renderMultiSelectIcon: selectState => (
      <Image source={getImage(selectState)} style={styles.multiIcon} />
    )
  };
  ...
  constructor(props) {
    ...
    const treeRoot = Array.isArray(data)
      ? {
          [childrenKey]: data,
          [idOnlyKey]: this.defaultRootId,
          [labelKey]: firstTitleLine
        }
      : {
          [childrenKey]: [data],
          [idOnlyKey]: this.defaultRootId,
    ...
    const tree = new Tree(treeRoot, undefined, childrenKey, idKey, treenode =>
  ...
  render() {
    const hasBottom =
      this.props.showBottomView !== undefined
  ...
  _renderPageView = () => {
    ...
    return (
      <View
        style={[{ width: totalWidth }, styles.displayView, this.state.frame]}
      >
    ...
    if (
      ...
      if (this.props.multiselect) {
        ...
        if (treeNode.isFullSelect(this.isCascade)) {
          if (
            this.props.directBackWhenSingle &&
